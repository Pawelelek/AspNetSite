            ...
            using (var serviceScope = applicationBuilder.ApplicationServices.CreateAsyncScope())
            {
                ...
                if (!context.SportEvents.Any())
                {
                    ...
                    var odds1 = new List<OddEntity>()
                    {
                        ...
                        new OddEntity { Name = $"DRAW", Value = (decimal)2.5, SportMatchId = match1.Id, Type = "Draw" },
                    ...
                    var odds2 = new List<OddEntity>()
                    {
                        ...
                        new OddEntity { Name = $"DRAW", Value = (decimal)2.5, SportMatchId = match2.Id, Type = "Draw" },
                    ...
                    var odds3 = new List<OddEntity>()
                    {
                        ...
                        new OddEntity { Name = $"DRAW", Value = (decimal)2.5, SportMatchId = match3.Id, Type = "Draw" },
                    ...
                    {
                        new OddEntity { Name = $"{opponent7.Name} - WIN", Value = (decimal)2.1, OpponentId = opponent7.Id, SportMatchId = match4.Id, Type = "Win1" },
                        new OddEntity { Name = $"DRAW", Value = (decimal)2.5, SportMatchId = match4.Id, Type = "Draw" },
                        new OddEntity { Name = $"{opponent8.Name} - WIN", Value = (decimal)2.3, OpponentId = opponent8.Id, SportMatchId = match4.Id, Type = "Win2" },
                    ...
                    {
                        new OddEntity { Name = $"{opponent9.Name} - WIN", Value = (decimal)2.1, OpponentId = opponent9.Id, SportMatchId = match5.Id, Type = "Win1" },
                        new OddEntity { Name = $"DRAW", Value = (decimal)2.5, SportMatchId = match5.Id, Type = "Draw" },
                        new OddEntity { Name = $"{opponent10.Name} - WIN", Value = (decimal)2.3, OpponentId = opponent10.Id, SportMatchId = match5.Id, Type = "Win2" },
                    ...
                    {
                        new OddEntity { Name = $"{opponent11.Name} - WIN", Value = (decimal)2.1, OpponentId = opponent11.Id, SportMatchId = match6.Id, Type = "Win1" },
                        new OddEntity { Name = $"DRAW", Value = (decimal)2.5, SportMatchId = match6.Id, Type = "Draw" },
                        ...
                        new OddEntity { Name = $"{opponent12.Name} - GOAL", Value = (decimal)2.45, OpponentId = opponent12.Id, SportMatchId = match6.Id, Type = "Goal2" },

                        new OddEntity { Name = $"{opponent11.Name} - TOTAL", Value = (decimal)1.8, OpponentId = opponent11.Id, SportMatchId = match6.Id, Type = "Total1" },
                        new OddEntity { Name = $"{opponent12.Name} - TOTAL", Value = (decimal)1.9, OpponentId = opponent12.Id, SportMatchId = match6.Id, Type = "Total2" },
                    };
